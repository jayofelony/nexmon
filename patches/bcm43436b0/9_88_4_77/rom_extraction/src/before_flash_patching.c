...
// 0x41772 relocated from 9_88_4_65 0x4101A: same init thunk (push {r3,lr};
// bl; bl; ldmia.w sp!,{r3,lr}; b.w fp_apply_patches) with the tail b.w now
// targeting the relocated fp_apply_patches at 0x40840. Same +0x758 delta as
// fp_apply_patches itself. Verify on device.
__attribute__((at(0x41772, "", CHIP_VER_BCM43436b0, FW_VER_9_88_4_77)))
