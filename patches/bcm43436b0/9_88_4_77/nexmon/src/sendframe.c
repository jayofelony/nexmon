...
// TODO(9_88_4_77): 0x353EA relocated from 9_88_4_65 0x3489E by 24-byte
// signature + disassembly context; this is a mid-function code patch tied to
// the exact instruction layout of the injection path - re-verify by
// disassembly on the device, and consider omitting it for first bring-up
// (it is a null-scb robustness fix, not core injection).
__attribute__((at(0x353EA, "", CHIP_VER_BCM43436b0, FW_VER_9_88_4_77)))
__attribute__((naked))
void
