...
// TODO(9_88_4_77): 0x3D37C relocated from 9_88_4_65 0x3CC10 - it is the unique
// aligned slot holding &wl_send|1 (0xA645, with wl_send at 0xA644 - see
// wrapper.c). Confirm on device (dump the dword at 0x3D37C).
__attribute__((at(0x3D37C, "", CHIP_VER_BCM43436b0, FW_VER_9_88_4_77)))
